...
speak("asdfjherdegtyrtjugedftgwaergwqwqfr");
		// 2. Catch the user's answer in a String
String answer = JOptionPane.showInputDialog("what did you hear?");
		// 3. If the user spelled the word correctly, speak "correct"
if (answer.equals("asdfjherdegtyrtjugedftgwaergwqwqfr")) {
	JOptionPane.showMessageDialog(null, "you are correct");
} 

		// 4. Otherwise say "wrong"
else {
	JOptionPane.showMessageDialog(null, "You is wrong");
}
